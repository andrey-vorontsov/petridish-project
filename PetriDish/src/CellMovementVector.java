 ...
 * 
 * A convenience class to package movement data for a cell and facilitate calculations for moving towards a target. Methods for using this class are packaged into the Cell abstract class.
 */
